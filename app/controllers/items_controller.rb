...
def show
  ...
  def item_params
    params.require(:item).permit(:name, :image, :description, :price, :category_id, :condition_id,  :shipping_fee_id, :shipping_time_id, :prefecture_id).merge(user: current_user)
  end
end
